...
const styles = StyleSheet.create({
  ...
  forgotText: { color: '#1A6FA8', fontSize: 13, fontWeight: '600' },
  loginBtn: {
    backgroundColor: '#1A6FA8',
    borderRadius: 14,
    paddingVertical: 16,
  ...
  guestBtnText: { color: '#1A6FA8', fontSize: 15, fontWeight: '600' },
  registerRow: {
    flexDirection: 'row',
    justifyContent: 'center',
    marginTop: 24,
  ...
  registerLink: { color: '#1A6FA8', fontSize: 14, fontWeight: '700' },
});
